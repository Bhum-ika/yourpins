    ...
    <main className="min-h-screen bg-gray-50 relative">
      ...
      <div className="max-w-4xl mx-auto px-10 pt-20 pb-10">
        ...
        <div className="flex justify-between items-center mb-8">
          ...
          <div className="flex items-center gap-1.5 bg-white border border-gray-100 rounded-full px-4 py-2">
        ...
        <div className="flex flex-col gap-3 mb-8">
          {links.map((link, index) => {
            ...
            return (
              <div
                key={link._id}
                className="bg-white border border-gray-100 rounded-2xl px-5 py-4 flex justify-between items-start hover:shadow-md transition-shadow"
              >
                {editingId === link._id ? (
                  ...
                  <>
                    <div className="flex gap-3 items-start">
                      <span style={{ color }} className="text-[10px] mt-1.5">●</span>
                      <div>
                        <p className="text-sm font-medium mb-0.5">{link.title}</p>
                        <a href={link.url} target="_blank" className="text-xs text-gray-400 hover:underline">
                          {link.url}
                        </a>
                        {link.description && (
